package com.michaelsalgado.apirest.apirest.Controllers;
...
import com.michaelsalgado.apirest.apirest.Entities.Producto;
import com.michaelsalgado.apirest.apirest.Repositories.ProductoRepository;
...
public class ProductoController {
    ...
    public Producto getProductoPorId(@PathVariable Long id) {
        return productoRepository.findById(id).orElseThrow(() -> new RuntimeException("No se encontró el ID: " + id));
    }
